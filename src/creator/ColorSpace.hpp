 ...
 */
rgba_t compositeRGBAOntoBackground(const rgba_t& rgba, const rgba_t& bg);
 ...
 * - http://www.brucelindbloom.com/
 */
double distance(const lab_t& color1, const lab_t& color2, DistanceAlgo algo = CIEDE2000);

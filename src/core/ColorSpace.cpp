...
ColorSpace::ColorLAB ColorSpace::toLAB(const ColorSpace::ColorRGBA& rgba) {
    ColorSpace::ColorRGBA rgb = rgba.alpha == 1 ? rgba : ColorSpace::compositeRGBAOntoBackground(rgba, {});

...
We do not track you. We do not use analytics tools or advertising cookies.

Our server receives technical information as part of every HTTP request – your IP address, browser type, and the page you came from.
This is how the internet works and is unavoidable, but we do not log or store this information.

We do keep minimal server logs (which page was requested, when, and whether it succeeded) for technical monitoring purposes.
These logs contain no personal information and are automatically deleted on every deployment or when the size limit is reached
(10 MB per server component), whichever comes first.

### If you use the website without an account
...
Patterns and other content you create are stored on our servers and linked to your account.
If you upload a photo to create a pattern, the original photo file is never stored.
...
- **Contract performance (Art. 6.1.b)** – processing your account data and content is necessary to provide the service you signed up for.
...
- **STRATO GmbH** (Germany) – server hosting and backups. Data processing agreement in place.
- **Heinlein Hosting GmbH / mailbox.org** (Germany) – email delivery. Data processing agreement in place.
...
- If you do not select "Keep me logged in", the cookie is deleted when you close your browser.
...
- **Correction** – you can update your data at any time in your account settings.
- **Deletion** – you can delete your account and all associated data at any time. Residual copies may remain in encrypted backups for up to 90 days.
  Note that in cases of suspected illegal content, account deletion may be temporarily suspended pending law enforcement investigation, as required by law (Art. 17.3 GDPR).
- **Restriction** – you can ask us to restrict processing of your data in certain circumstances.
- **Portability** – you can request your data in a machine-readable format.
- **Objection** – you can object to processing based on legitimate interest.

To exercise any of these rights, contact us at mail@kreuzstich.art. We will respond within 30 days.
...
If you have any questions about this policy or about your data, contact us at mail@kreuzstich.art.

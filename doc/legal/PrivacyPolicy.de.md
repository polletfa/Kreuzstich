...
### Wenn du die Website nur besuchst

Wir verfolgen dich nicht. Wir verwenden keine Analyse- oder Werbe-Cookies.

Unser Server empfängt technische Informationen als Teil jeder HTTP-Anfrage – deine IP-Adresse, deinen Browsertyp und die Seite, von der du gekommen bist.
So funktioniert das Internet, das lässt sich nicht vermeiden – wir speichern oder protokollieren diese Informationen jedoch nicht.

Wir führen minimale Server-Logs (welche Seite wann aufgerufen wurde und ob die Anfrage erfolgreich war) zu technischen Zwecken.
Diese Logs enthalten keine personenbezogenen Daten und werden bei jedem Deployment oder beim Erreichen der Größenbeschränkung
(10 MB pro Serverkomponente) automatisch gelöscht, je nachdem, was zuerst eintritt.

### Wenn du die Website ohne Konto verwendest
...
Muster und andere Inhalte, die du erstellst, werden auf unseren Servern gespeichert und mit deinem Konto verknüpft.
Wenn du ein Foto hochlädst, um ein Muster zu erstellen, wird die originale Fotodatei niemals gespeichert.
...
- **Vertragserfüllung (Art. 6 Abs. 1 lit. b DSGVO)** – die Verarbeitung deiner Kontodaten und Inhalte ist notwendig, um den Dienst bereitzustellen, für den du dich angemeldet hast.
...
Wir verkaufen oder teilen deine Daten nicht zu kommerziellen Zwecken mit Dritten.

Wir nutzen folgende Dienstleister zum Betrieb der Plattform:

- **STRATO GmbH** (Deutschland) – Server-Hosting und Backups. Auftragsverarbeitungsvertrag abgeschlossen.
- **Heinlein Hosting GmbH / mailbox.org** (Deutschland) – E-Mail-Versand. Auftragsverarbeitungsvertrag abgeschlossen.
...
- Wenn du „Angemeldet bleiben“ nicht auswählst, wird das Cookie beim Schließen des Browsers gelöscht.
...
- **Auskunft** – du kannst eine Kopie der von uns gespeicherten Daten anfordern.
- **Berichtigung** – du kannst deine Daten jederzeit in den Kontoeinstellungen aktualisieren.
- **Löschung** – du kannst dein Konto und alle zugehörigen Daten jederzeit löschen. Restdaten können bis zu 90 Tage in verschlüsselten Backups verbleiben.
  Bitte beachte, dass im Falle von vermutetem illegalem Inhalt die Kontolöschung bis zum Abschluss der behördlichen Ermittlungen vorübergehend ausgesetzt werden kann,
  wie gesetzlich vorgeschrieben (Art. 17 Abs. 3 DSGVO).
- **Einschränkung** – du kannst uns unter bestimmten Umständen bitten, die Verarbeitung deiner Daten einzuschränken.
...
Um eines dieser Rechte auszuüben, kontaktiere uns unter mail@kreuzstich.art. Wir antworten innerhalb von 30 Tagen.
...
Wenn du Fragen zu dieser Erklärung oder zu deinen Daten hast, kontaktiere uns unter mail@kreuzstich.art.
